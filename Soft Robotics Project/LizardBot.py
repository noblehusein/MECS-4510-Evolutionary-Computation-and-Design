...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 22:15:10 2021
...
def InitialiseBot():
    ...
    masses.append((m,[0.1,0.1,0+n],[0,0,0],[0,0,0])) #m0
    
    masses.append((m,[0.2,0.1,0+n],[0,0,0],[0,0,0])) #m1
    
    masses.append((m,[0.1,0.2,0+n],[0,0,0],[0,0,0])) #m2
    
    masses.append((m,[0.1,0.1,0.1+n],[0,0,0],[0,0,0])) #m3
    
    masses.append((m,[0.1,0.2,0.1+n],[0,0,0],[0,0,0])) #m4
    
    masses.append((m,[0.2,0.2,0+n],[0,0,0],[0,0,0])) #m5
    
    masses.append((m,[0.2,0.1,0.1+n],[0,0,0],[0,0,0])) #m6
    
    masses.append((m,[0.2,0.2,0.1+n],[0,0,0],[0,0,0])) #m7
    
    #New cUBE
    masses.append((m,[0.3,0.1,0+n],[0,0,0],[0,0,0])) #m8
    
    masses.append((m,[0.3,0.2,0+n],[0,0,0],[0,0,0])) #m9
    
    masses.append((m,[0.3,0.1,0.1+n],[0,0,0],[0,0,0])) #m10
    
    masses.append((m,[0.3,0.2,0.1+n],[0,0,0],[0,0,0])) #m11
    
    #new cube
    
    masses.append((m,[0.4,0.1,0+n],[0,0,0],[0,0,0])) #m12
    
    masses.append((m,[0.4,0.2,0+n],[0,0,0],[0,0,0])) #m13
    
    masses.append((m,[0.4,0.1,0.1+n],[0,0,0],[0,0,0])) #m14
    
    masses.append((m,[0.4,0.2,0.1+n],[0,0,0],[0,0,0])) #m15
    
    #new cube
    
    masses.append((m,[0.5,0.1,0+n],[0,0,0],[0,0,0])) #m16
    
    masses.append((m,[0.5,0.2,0+n],[0,0,0],[0,0,0])) #m17
    
    masses.append((m,[0.5,0.1,0.1+n],[0,0,0],[0,0,0])) #m18
    
    masses.append((m,[0.5,0.2,0.1+n],[0,0,0],[0,0,0])) #m19
    
    
    
    #newSideCube
    
    masses.append((m,[0.1,0.3,0+n],[0,0,0],[0,0,0])) #m20
    
    masses.append((m,[0.2,0.3,0+n],[0,0,0],[0,0,0])) #m21
    
    masses.append((m,[0.1,0.3,0.1+n],[0,0,0],[0,0,0])) #m22
    
    masses.append((m,[0.2,0.3,0.1+n],[0,0,0],[0,0,0])) #m23
    
    #newSideCube
    
    masses.append((m,[0.1,0,0+n],[0,0,0],[0,0,0])) #m24
    
    masses.append((m,[0.2,0,0+n],[0,0,0],[0,0,0])) #m25
    
    masses.append((m,[0.1,0,0.1+n],[0,0,0],[0,0,0])) #m26
    
    masses.append((m,[0.2,0,0.1+n],[0,0,0],[0,0,0])) #m27
    
    
    #newSideCube which is at the back
    
    masses.append((m,[0.4,0.3,0+n],[0,0,0],[0,0,0])) #m28
    
    masses.append((m,[0.5,0.3,0+n],[0,0,0],[0,0,0])) #m29
    
    masses.append((m,[0.4,0.3,0.1+n],[0,0,0],[0,0,0])) #m30
    
    masses.append((m,[0.5,0.3,0.1+n],[0,0,0],[0,0,0])) #m31
    
    
    #newSideCube which is at the back
    
    masses.append((m,[0.4,0,0+n],[0,0,0],[0,0,0])) #m32
    
    masses.append((m,[0.5,0,0+n],[0,0,0],[0,0,0])) #m33
    
    masses.append((m,[0.4,0,0.1+n],[0,0,0],[0,0,0])) #m34
    
    masses.append((m,[0.5,0,0.1+n],[0,0,0],[0,0,0])) #m35
    springs=[]
...
def Simulation(masses,springs,DNA):
    T=0
    t=0
    dt = 0.001
    
    while T < 20*np.pi*0.1: 
            ...
            for i in range(len(masses)):
                  ...
                  masses[i][1][0] = masses[i][1][0]+ masses[i][2][0]*dt
                  masses[i][1][1] = masses[i][1][1]+ masses[i][2][1]*dt   
                  masses[i][1][2] = masses[i][1][2]+ masses[i][2][2]*dt
...
def mutation(List,murate):
  for i in range(len(List)):
    if (random.random()< murate):
      ...
      while List[j] == random.choice((0,1,2,3)):
         List[j]=random.choice((0,1,2,3))
...
def EA(mutrate,n,iter):
    ...
    while i< iter:
        ...
        for k in range(0,n):
            print(len(pop))
            masses,springs=InitialiseBot()
            finalCM=Simulation(masses, springs,pop[k])
            newSpeed=(np.sqrt(np.sum(np.square(np.array(finalCM)-np.array(initialCM)))))/(np.pi*0.1)
...
masses,springs=InitialiseBot()
#DNA=[20000,0,0]* len(springs)
DNA=random.choices([1], k = len(springs))
Simulation(masses,springs,DNA)
